...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <span class="pull-right"><a class="btn btn-xs" href="/user/site" title="" data-toggle="tooltip" data-original-title="帐户设置"><i class="fa fa-cog"></i> </a></span>
    </div>
    <div class="panel-body">
        <ul class="user-info">
            <li><i class="fa fa-calendar fa-fw"></i> 注册日期：2015-04-09</li>
