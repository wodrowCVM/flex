    ...
    <div class="panel-body">
        <div class="media">
            <div class="media-left media-middle">
                <img class="media-object" src="https://getyii.com/uploads/avatars/cache/100_p4NoozEhjVx3DI-vkkb3mWHSeMd0qQ9t.png" alt="">                    </div>
            <div class="media-body">
                <h2 class="mt5"><strong>wodrow</strong></h2>
                <p>第 288 位会员</p>
                <div class="pull-left">
        ...
        <div class="follow-info row">
            <div class="col-sm-4 followers" data-login="rei">
                <a class="counter" href="/member/wodrow/point">
                    16                        </a>
                <a class="text" href="/member/wodrow/point">积分</a>
            </div>
