...
<?php else: ?>
    <?= \dmstr\helpers\Html::a(\kartik\icons\Icon::show('thumbs-o-up') . $praise_count, ['', '_pjax'=>'#talk_praise_icon_'.$talk->id, 'praise_talk_id' => $talk->id], ['class' => "vote up", 'data-type' => "feed", 'data-id' => $talk->id]) ?>
<?php endif; ?>
